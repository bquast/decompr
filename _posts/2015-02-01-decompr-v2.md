...
In addition to this, a new [minimalist dataset](/decompr/leather-data) has been bundled, in order to introdue the user to the data format as well as the difference between the two decomposition methods.
